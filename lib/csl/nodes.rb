...
module CSL
  ...
  class Node      
    ...
    class << self; attr_reader :formatting_attributes; end

    def self.parse(node)
      # Hash[attributes.values.map { |a| [a.name, a.value] }]
    end
  end
  ...
  class Name < Node
    attr_fields Node.formatting_attributes
    attr_fields %w{ and delimiter-precedes-last et-al-min et-al-use-first
      et-al-subsequent-min et-al-subsequent-use-first form initialize-with
